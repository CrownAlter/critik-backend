 ...
 * 
 * Security Decisions:
 * - CSRF is disabled because we use stateless JWT authentication (no cookies for auth)
...
public class SecurityConfig {
    ...
    /**
     * CORS allowed origins - configure via environment variable for different environments.
